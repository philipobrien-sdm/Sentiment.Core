...
export const StakeholderMappingModal: React.FC<StakeholderMappingModalProps> = ({
  ...
  const handleSaveCurrentOrg = () => {
    ...
    showToast(`Saved stakeholder mapping for "${targetOrg}" (${activeQuadrant.shortLabel})`, "success");
  };
                ...
                {uniqueOrganizations.map((org) => {
                  ...
                  return (
                    <div
                      ...
                      title={`${org}: Influence ${orgInf.toFixed(1)}, Interest ${orgInt.toFixed(1)} (${qInfo.shortLabel})`}
                    >
